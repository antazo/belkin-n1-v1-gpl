...
{
	{"upnp:rootdevice",uuid_igd,ROOT_DEVICE},
	{"urn:schemas-upnp-org:device:InternetGatewayDevice:",uuid_igd,EMBED_DEVICE},
	{"urn:schemas-upnp-org:device:WANConnectionDevice:",uuid_wancd,EMBED_DEVICE},
	{"urn:schemas-upnp-org:device:WANDevice:",uuid_wand,EMBED_DEVICE},
	{"urn:schemas-upnp-org:device:LANDevice:",uuid_land,EMBED_DEVICE},
	{"urn:schemas-upnp-org:service:WANCommonInterfaceConfig:",uuid_land,SERVICE},
	{"urn:schemas-upnp-org:service:WANPPPConnection:",uuid_land,SERVICE},
	{"urn:schemas-upnp-org:service:Layer3Forwarding:",uuid_igd,SERVICE},
	{NULL,NULL,0}
};
...
main(int argc, char * * argv)
{
	...
	if(wan_type == 0)/* is ip connection*/
		igd_service_types = IPConnection_service_types;
	else
	{
		if(wan_type == 1)
			igd_service_types = PPPConnection_service_types;
		else
		{
