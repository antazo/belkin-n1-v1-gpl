...
/* $Id: //depot/sw/src3/linux/kernels/mips-linux-2.6.15/drivers/char/applicom.c#1 $			     */
...
int __init applicom_init(void)
{
	...
	printk(KERN_INFO "Applicom driver: $Id: //depot/sw/src3/linux/kernels/mips-linux-2.6.15/drivers/char/applicom.c#1 $\n");
