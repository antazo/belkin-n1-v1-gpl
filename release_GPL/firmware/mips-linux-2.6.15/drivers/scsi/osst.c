/*
  ...
  $Header: //depot/sw/src3/linux/kernels/mips-linux-2.6.15/drivers/scsi/osst.c#1 $
...
static const char * cvsid = "$Id: //depot/sw/src3/linux/kernels/mips-linux-2.6.15/drivers/scsi/osst.c#1 $";
