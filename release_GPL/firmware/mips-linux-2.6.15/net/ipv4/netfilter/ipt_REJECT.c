...
#endif
#ifdef _SC_BUILD_
#define BLKPAGE_DEF "HTTP/1.0 200 OK\r\nServer: Router\r\nConten-Type:text/html\r\n\r\n<html><BODY  onLoad=\"window.location.href = 'http://192.168.2.1/wiz_start0.html'\"></body></html>"
#endif
...
#if 0
unsigned int kread_file(char *path,unsigned int imageLength,char *ptr)
{
...
static void send_block(struct sk_buff *oldskb, int hook)
{
	...
	tcph->check = tcp_v4_check(tcph, sizeof(struct tcphdr) + len,
				   nskb->nh.iph->saddr,
				   nskb->nh.iph->daddr,
